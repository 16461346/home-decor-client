...
const ErrorPage = () => {
  ...
  return (
    <div class="w-full h-screen flex flex-col items-center justify-center">
      <svg
        class="w-1/2 md:w-1/3 lg:w-1/4 text-yellow-400"
      ...
      <div class="flex flex-col items-center justify-center">
        <p class="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-gray-600 mt-6">
          404
        </p>
      ...
      <div className="flex mt-4 gap-2 items-center justify-center">
        <a
          onClick={() => navigate(-1)}
          class=" bg-yellow-300  text-black border-gray-600 font-bold rounded shadow hover:shadow-lg py-2 px-4 border-2 cursor-pointer transition-all transform hover:scale-103"
        >
          Go Back
        </a>
        <a
